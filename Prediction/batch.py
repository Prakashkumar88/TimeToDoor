...
class batch_prediction:
    ...
    def start_batch_prediction(self):
        try:
            ...
            df.to_csv("df_delivery_time_prediction.csv", index=False)
            ...
            file_path = os.path.join(FEATURE_ENGINEERING_PATH, "bath_feature_eng.csv")
            ...
            logging.info(f"Batch prediction completed and saved to {csv_path}")
